 ...
 */
final class Version20220225134210 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE bien (id INT AUTO_INCREMENT NOT NULL, agent_id INT NOT NULL, title VARCHAR(100) NOT NULL, description VARCHAR(255) NOT NULL, photo VARCHAR(50) NOT NULL, vente TINYINT(1) NOT NULL, type VARCHAR(50) NOT NULL, surface INT NOT NULL, taille_du_terrain INT DEFAULT NULL, nombre_de_piece INT NOT NULL, etage INT NOT NULL, adresse VARCHAR(255) NOT NULL, prix INT NOT NULL, date_de_construction DATETIME DEFAULT NULL, INDEX IDX_45EDC3863414710B (agent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
